...
class MUCDatabase extends Database {
    ...
    public static boolean addMUC(String muc, String number) {
        ContentValues numbers = composeValues(muc, number);
        long ret = database.insert(DatabaseOpenHelper.MUC_TABLE_NAME, null, numbers);
        return ret != -1;
    }
    
    public static boolean updateMUC(String muc, String number) {
        ContentValues numbers = composeValues(muc, number);
    ...
    public static String[][] getFullDatabase() {
        Cursor c = databaseRO.query(DatabaseOpenHelper.MUC_TABLE_NAME, new String[] { "muc", "number"}, null, null, null , null, null);
    ...
    private static ContentValues composeValues(String muc, String number) {
