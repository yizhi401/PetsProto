...
import cn.peterchen.imtest.ui.LoginActivity;
import cn.peterchen.imtest.xmpp.receivers.NetworkConnectivityReceiver;
import cn.peterchen.imtest.xmpp.receivers.PublicIntentReceiver;
import cn.peterchen.imtest.xmpp.receivers.StorageLowReceiver;
import cn.peterchen.imtest.xmpp.tool.CrashedStartCounter;
import cn.peterchen.imtest.xmpp.tool.DisplayToast;
...
public class MainService extends Service {
	...
	public final static String ACTION_CONNECT = "com.lianxi.mos.demo.action.CONNECT";
	public final static String ACTION_DISCONNECT = "com.lianxi.mos.demo.action.DISCONNECT";
	public final static String ACTION_TOGGLE = "com.lianxi.mos.demo.action.TOGGLE";
	public final static String ACTION_SEND = "com.lianxi.mos.demo.action.SEND";

	// The following actions are undocumented and internal to our
	// implementation.
	public final static String ACTION_BROADCAST_STATUS = "com.lianxi.mos.demo.action.BROADCAST_STATUS";
	public final static String ACTION_NETWORK_STATUS_CHANGED = "com.lianxi.mos.demo.action.NETWORK_STATUS_CHANGED";

	// A list of intent actions that the XmppManager broadcasts.
	public static final String ACTION_XMPP_MESSAGE_RECEIVED = "com.lianxi.mos.demo.action.XMPP.MESSAGE_RECEIVED";
	public static final String ACTION_XMPP_PRESENCE_CHANGED = "com.lianxi.mos.demo.action.XMPP.PRESENCE_CHANGED";
	public static final String ACTION_XMPP_CONNECTION_CHANGED = "com.lianxi.mos.demo.action.XMPP.CONNECTION_CHANGED";
	 ...
	 *            can be null
	 * @param showPrefix
	 *            show the app name as prefix to the toast message
	 */
