package cn.peterchen.imtest.xmpp.databases;
...
class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String ALIAS_TABLE_DROP =
        "DROP TABLE " + ALIAS_TABLE_NAME;
    ...
    private static final String KV_TABLE_DROP =
    ...
    private static final String MUC_TABLE_DROP =
            "DROP TABLE " + MUC_TABLE_NAME;
    ...
    private static final String SMS_TABLE_DROP =
            "DROP TABLE " + SMS_TABLE_NAME;
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 4) {
            Log.w("Upgrading MUC database from " + oldVersion + " to " + newVersion);
            db.execSQL(MUC_TABLE_CREATE);
        }
        if (oldVersion < 5) {
            ...
            try {
                ...
                Log.e("Failed to drop table SMS", e);
            }
            db.execSQL(SMS_TABLE_CREATE);
        }
    }
